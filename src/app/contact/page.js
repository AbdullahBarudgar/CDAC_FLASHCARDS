...
Feel free to reach out to us at any time. We are here to assist you with any questions or concerns you may have. Below are our contact details:              </p>
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Delhi,110001</p>
                </div>
              </div>
              <div className="flex items-center mb-4">
                <svg className="w-6 h-6 text-gray-400 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <p className="text-gray-600">+91 7375826729</p>
                </div>
              </div>
              <div className="flex items-center mb-4">
                <svg className="w-6 h-6 text-gray-400 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <p className="text-gray-600">barudgarabdullah@gmail.com</p>
                </div>
              </div>
            </div>
