        ...
        <div className="mt-16 bg-gray-50 p-8 rounded-lg shadow-lg">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full border text-black border-gray-300 p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 mb-4"
            />
          </div>
            ...
            <div key={index} className="mb-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="border text-black border-gray-300 p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <input
                  type="text"
                  placeholder="Back"
